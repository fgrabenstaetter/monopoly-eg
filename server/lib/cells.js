...
module.exports = [
    ...
    new Cell(Constants.CELL_TYPE.OTHER, null),                                               // case 4 = impot sur le revenu
    ...
    new Cell(Constants.CELL_TYPE.PUBLIC_COMPANY, new PublicCompany(Properties.PUBLIC_COMPANY[0])),  // case 12
    ...
    new Cell(Constants.CELL_TYPE.PUBLIC_COMPANY, new PublicCompany(Properties.PUBLIC_COMPANY[1])),   // case 28
    ...
    new Cell(Constants.CELL_TYPE.OTHER, null),                                               // case 38 = Taxe de luxe
